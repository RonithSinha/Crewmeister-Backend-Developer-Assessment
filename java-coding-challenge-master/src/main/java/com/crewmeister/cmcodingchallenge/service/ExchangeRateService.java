...
public interface ExchangeRateService {
	...
	/**
	 * Loads currency exchange rate data into the system. Typically invoked on
	 * application startup to fetch and cache the exchange rate data.
	 */
	void loadCurrencyExchangeRateData();
}
